...
1. Review the new docs for public-facing clarity.
2. Decide whether to keep or remove the sample `outputs/` artifacts from the repo.
3. Publish the repo updates upstream when satisfied.
